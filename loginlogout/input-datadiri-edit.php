...
<form action="input-datadiri-edit.php" method="POST">
    ...
    <input value="<?php echo $row["namalengkap"]; ?>" type="text" name="nama" placeholder="Ex.Kharisya"/><br>

    <label for="kelas">Tanggal Lahir :</p>
    <input value="<?php echo $row["tanggal_lahir"]; ?>" type="date" name="tanggal_lahir"/><br>

    <label for="nilai">Nilai</label><br>
    <input value="<?php echo $row["nilai"]; ?>" type="number" name="nilai" placeholder="Ex.99.99" /><br>
    <br>
    <input type="submit" name="edit" value="Edit Data"/>
    <a href="input-datadiri.php">Kembali</a><br>
